...
- wypisanie na standardowym wyjściu liczb od 1 do 100

- wypisanie na standardowym wyjściu aktualnego czasu

- wypisanie na standardowym wyjściu liczby otrzymanych żądań zmiany trybu pracy od początku działania programu

- wypisywanie na standardowym wyjściu aktualnego czasu co jedną sekundę aż do momentu otrzymania innego trybu pracy

- zakończenie działania programu catcher
