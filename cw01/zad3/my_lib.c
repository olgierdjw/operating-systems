...
//int main() {
//    // zmienna firstMainBlock trzyma adres do MainBlock
//    struct MainBlock *firstMainBlock = initMainBlock(10);
//    addTextBlock(firstMainBlock, "text1.txt");
//    addTextBlock(firstMainBlock, "text1.txt");
//    printf("liczba zapisanych bloków: %zu\n", firstMainBlock->dataBlockCnt);
//    printTextBlock(firstMainBlock, 0);
//    printTextBlock(firstMainBlock, 1);
//    printTextBlock(firstMainBlock, 2);
//    printTextBlock(firstMainBlock, 3);
//    deleteMainBlock(firstMainBlock);
//}